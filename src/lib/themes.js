export const THEMES = [
  ...
  },
  {
    id: 'rose',
    label: '🌸 Rose',
    gradient: 'linear-gradient(160deg, #fda4af 0%, #e11d48 60%, #be123c 100%)',
    drawer: 'rgba(190,18,60,0.97)',
    blob1: '#fecdd3', blob2: '#fb7185', blob3: '#fda4af',
  },
  {
    id: 'forest',
    label: '🌿 Forêt',
    gradient: 'linear-gradient(160deg, #86efac 0%, #16a34a 60%, #15803d 100%)',
    drawer: 'rgba(21,128,61,0.97)',
    blob1: '#bbf7d0', blob2: '#4ade80', blob3: '#86efac',
  },
  {
    id: 'night',
    label: '🌙 Nuit',
